...
*Set Working Directory to ./amazon-ecs-gmsa/cloud-formation-templates/*
...
$gMSASQLPasswordParam = "gMSA-blog-SQL-Password"
...
$gMSAADSecurityGroup = "gmsa-container-securitygroup" # AD Security group to which gMSA account will be associated and ECS Workers will be member of this AD security group.
...
$gMSACredSpecParam = "gmsa-blog-credspecparam" # SSM parameter name that stores gMSA credential spec content
$gMSATaskExecutionRole = "gmsa-task-execution-role" # Task execution role (to be created) which has access to S3 and SSM parameter (Credentialspec).
##### DEFAULT VALUES - END #####
```
